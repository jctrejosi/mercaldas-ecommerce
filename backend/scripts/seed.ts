...
async function seed() {
  ...
  try {
    ...
    // Sucursal Centro
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-001', 'Mercaldas Centro',
      ...
      ON CONFLICT (code) DO UPDATE SET
        ...
        schedule = EXCLUDED.schedule, priority = EXCLUDED.priority,
        location = EXCLUDED.location, manager_name = EXCLUDED.manager_name,
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-002', 'Mercaldas Avenida Alberto Mendoza',
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-003', 'Mercaldas La Estación',
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-004', 'Mercaldas La Fuente',
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-005', 'Mercaldas Palogrande',
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-006', 'Mercaldas Sede principal',
    ...
    await db.execute(sql`
      INSERT INTO branches (code, name, address, city, phone, store_id, email,
        manager_name, manager_phone, priority, branch_type,
        location, delivery_radius_km, schedule, is_active)
      VALUES ('SUC-007', 'Mercaldas Milán',
        'Cra 23 # 64-60, Barrio Milán', 'Manizales',
